 ...
 *
 * @since 2.1
 * @source $URL: http://gtsvn.refractions.net/trunk/modules/unsupported/epsg-oracle/src/main/java/org/geotools/referencing/factory/epsg/FactoryUsingOracleSQL.java $
