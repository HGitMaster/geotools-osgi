 ...
 * @source $URL: http://svn.osgeo.org/geotools/tags/2.6.2/modules/unsupported/app-schema/jdbc-regfunc/src/main/java/org/geotools/filter/RegfuncFilterFactoryImpl.java $
 * @since 2.4
 */
