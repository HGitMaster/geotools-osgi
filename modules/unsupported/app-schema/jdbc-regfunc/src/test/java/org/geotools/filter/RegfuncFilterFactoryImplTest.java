 ...
 * @source $URL: http://svn.osgeo.org/geotools/tags/2.6.5/modules/unsupported/app-schema/jdbc-regfunc/src/test/java/org/geotools/filter/RegfuncFilterFactoryImplTest.java $
 * @since 2.4
 */
