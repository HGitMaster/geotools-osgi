 ...
 * @source $URL: http://gtsvn.refractions.net/trunk/modules/unsupported/app-schema/jdbc-regfunc/src/test/java/org/geotools/data/postgis/RegFuncPostgisDataStoreOnlineTest.java $
 * @since 2.4
 */
