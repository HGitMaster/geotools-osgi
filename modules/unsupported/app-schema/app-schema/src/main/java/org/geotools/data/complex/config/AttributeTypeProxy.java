 ...
 * @source $URL: http://gtsvn.refractions.net/trunk/modules/unsupported/app-schema/app-schema/src/main/java/org/geotools/data/complex/config/AttributeTypeProxy.java $
 * @since 2.4
 */
