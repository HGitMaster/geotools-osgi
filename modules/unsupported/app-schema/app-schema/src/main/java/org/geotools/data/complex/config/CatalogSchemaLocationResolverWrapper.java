 ...
 * @source $URL: http://gtsvn.refractions.net/trunk/modules/unsupported/app-schema/app-schema/src/main/java/org/geotools/data/complex/config/CatalogSchemaLocationResolverWrapper.java $
 * @since 2.6
 */
