...
public class InMemoryFeatureCacheBenchmarkXest extends TestCase {
    ...
    public void testDataCacheConformance()
        throws IOException, SchemaException, FeatureCacheException {
    ...
    private static QueryStatistics[] runQueries(FeatureSource fs, List querySet) {
        ...
        while (iter.hasNext()) {
            ...
            try {
                ...
                //System.out.print(".") ;
                FeatureCollection resultSet = fs.getFeatures(q);
