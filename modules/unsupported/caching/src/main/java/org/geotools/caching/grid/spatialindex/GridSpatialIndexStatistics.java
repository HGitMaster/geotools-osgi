 ...
 *
 *
 * @source $URL: http://svn.osgeo.org/geotools/tags/8.0-M1/modules/unsupported/caching/src/main/java/org/geotools/caching/grid/spatialindex/GridSpatialIndexStatistics.java $
 */
