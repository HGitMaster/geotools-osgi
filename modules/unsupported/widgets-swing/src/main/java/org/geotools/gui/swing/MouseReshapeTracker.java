 ...
 * </pre></blockquote>
 *
 * @source $URL: http://svn.osgeo.org/geotools/tags/2.6.5/modules/unsupported/widgets-swing/src/main/java/org/geotools/gui/swing/MouseReshapeTracker.java $
 * @version $Id: MouseReshapeTracker.java 30655 2008-06-12 20:24:25Z acuster $
...
class MouseReshapeTracker extends MouseInputAdapter implements Shape {
     ...
     * bit bigger than the user has requested. In this case, {@code drawnShape} will serve as
    ...
    /**
     * {@code x}, {@code y}, {@code width} and {@code height} coordinates of a
            ...
            throws IllegalArgumentException
    {
        ...
        if (editors == null) {
            ...
            editors = XArray.resize(editors, editors.length + 1);
        }
