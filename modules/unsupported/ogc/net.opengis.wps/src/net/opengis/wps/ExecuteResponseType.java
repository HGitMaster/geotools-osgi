 ...
 * </copyright>
 *
 * $Id: ExecuteResponseType.java 30488 2008-06-02 23:31:41Z gdavis $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.ExecuteResponseType#getProcess <em>Process</em>}</li>
 *   <li>{@link net.opengis.wps.ExecuteResponseType#getStatus <em>Status</em>}</li>
 *   <li>{@link net.opengis.wps.ExecuteResponseType#getDataInputs <em>Data Inputs</em>}</li>
 *   <li>{@link net.opengis.wps.ExecuteResponseType#getOutputDefinitions <em>Output Definitions</em>}</li>
 *   <li>{@link net.opengis.wps.ExecuteResponseType#getProcessOutputs <em>Process Outputs</em>}</li>
 *   <li>{@link net.opengis.wps.ExecuteResponseType#getServiceInstance <em>Service Instance</em>}</li>
 *   <li>{@link net.opengis.wps.ExecuteResponseType#getStatusLocation <em>Status Location</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wps.WpsPackage#getExecuteResponseType()
...
public interface ExecuteResponseType extends ResponseBaseType {
	 ...
	 * @see net.opengis.wps.WpsPackage#getExecuteResponseType_Process()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.ExecuteResponseType#getProcess <em>Process</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getExecuteResponseType_Status()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.ExecuteResponseType#getStatus <em>Status</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getExecuteResponseType_DataInputs()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.ExecuteResponseType#getDataInputs <em>Data Inputs</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getExecuteResponseType_OutputDefinitions()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.ExecuteResponseType#getOutputDefinitions <em>Output Definitions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getExecuteResponseType_ProcessOutputs()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.ExecuteResponseType#getProcessOutputs <em>Process Outputs</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getExecuteResponseType_ServiceInstance()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.ExecuteResponseType#getServiceInstance <em>Service Instance</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getExecuteResponseType_StatusLocation()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.ExecuteResponseType#getStatusLocation <em>Status Location</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
