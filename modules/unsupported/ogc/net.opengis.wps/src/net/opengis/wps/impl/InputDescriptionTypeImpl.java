 ...
 * </copyright>
 *
 * $Id: InputDescriptionTypeImpl.java 29861 2008-04-09 04:55:54Z jdeolive $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.impl.InputDescriptionTypeImpl#getComplexData <em>Complex Data</em>}</li>
 *   <li>{@link net.opengis.wps.impl.InputDescriptionTypeImpl#getLiteralData <em>Literal Data</em>}</li>
 *   <li>{@link net.opengis.wps.impl.InputDescriptionTypeImpl#getBoundingBoxData <em>Bounding Box Data</em>}</li>
 *   <li>{@link net.opengis.wps.impl.InputDescriptionTypeImpl#getMaxOccurs <em>Max Occurs</em>}</li>
 *   <li>{@link net.opengis.wps.impl.InputDescriptionTypeImpl#getMinOccurs <em>Min Occurs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InputDescriptionTypeImpl extends DescriptionTypeImpl implements InputDescriptionType {
	...
	protected EClass eStaticClass() {
		return WpsPackage.eINSTANCE.getInputDescriptionType();
	}
	...
	public NotificationChain basicSetComplexData(SupportedComplexDataInputType newComplexData, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WpsPackage.INPUT_DESCRIPTION_TYPE__COMPLEX_DATA, oldComplexData, newComplexData);
	...
	public void setComplexData(SupportedComplexDataInputType newComplexData) {
		if (newComplexData != complexData) {
			...
			if (complexData != null)
				msgs = ((InternalEObject)complexData).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WpsPackage.INPUT_DESCRIPTION_TYPE__COMPLEX_DATA, null, msgs);
			if (newComplexData != null)
				msgs = ((InternalEObject)newComplexData).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WpsPackage.INPUT_DESCRIPTION_TYPE__COMPLEX_DATA, null, msgs);
			msgs = basicSetComplexData(newComplexData, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.INPUT_DESCRIPTION_TYPE__COMPLEX_DATA, newComplexData, newComplexData));
	}
	...
	public NotificationChain basicSetLiteralData(LiteralInputType newLiteralData, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WpsPackage.INPUT_DESCRIPTION_TYPE__LITERAL_DATA, oldLiteralData, newLiteralData);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLiteralData(LiteralInputType newLiteralData) {
		if (newLiteralData != literalData) {
			NotificationChain msgs = null;
			if (literalData != null)
				msgs = ((InternalEObject)literalData).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WpsPackage.INPUT_DESCRIPTION_TYPE__LITERAL_DATA, null, msgs);
			if (newLiteralData != null)
				msgs = ((InternalEObject)newLiteralData).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WpsPackage.INPUT_DESCRIPTION_TYPE__LITERAL_DATA, null, msgs);
			msgs = basicSetLiteralData(newLiteralData, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.INPUT_DESCRIPTION_TYPE__LITERAL_DATA, newLiteralData, newLiteralData));
	}
	...
	public NotificationChain basicSetBoundingBoxData(SupportedCRSsType newBoundingBoxData, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WpsPackage.INPUT_DESCRIPTION_TYPE__BOUNDING_BOX_DATA, oldBoundingBoxData, newBoundingBoxData);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setBoundingBoxData(SupportedCRSsType newBoundingBoxData) {
		if (newBoundingBoxData != boundingBoxData) {
			...
			if (boundingBoxData != null)
				msgs = ((InternalEObject)boundingBoxData).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WpsPackage.INPUT_DESCRIPTION_TYPE__BOUNDING_BOX_DATA, null, msgs);
			if (newBoundingBoxData != null)
				msgs = ((InternalEObject)newBoundingBoxData).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WpsPackage.INPUT_DESCRIPTION_TYPE__BOUNDING_BOX_DATA, null, msgs);
			msgs = basicSetBoundingBoxData(newBoundingBoxData, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.INPUT_DESCRIPTION_TYPE__BOUNDING_BOX_DATA, newBoundingBoxData, newBoundingBoxData));
	}
	...
	public void setMaxOccurs(BigInteger newMaxOccurs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.INPUT_DESCRIPTION_TYPE__MAX_OCCURS, oldMaxOccurs, maxOccurs));
	}
	...
	public void setMinOccurs(BigInteger newMinOccurs) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.INPUT_DESCRIPTION_TYPE__MIN_OCCURS, oldMinOccurs, minOccurs));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WpsPackage.INPUT_DESCRIPTION_TYPE__COMPLEX_DATA:
				return basicSetComplexData(null, msgs);
			case WpsPackage.INPUT_DESCRIPTION_TYPE__LITERAL_DATA:
				return basicSetLiteralData(null, msgs);
			case WpsPackage.INPUT_DESCRIPTION_TYPE__BOUNDING_BOX_DATA:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WpsPackage.INPUT_DESCRIPTION_TYPE__MAX_OCCURS:
				return getMaxOccurs();
			case WpsPackage.INPUT_DESCRIPTION_TYPE__MIN_OCCURS:
				return getMinOccurs();
		}
