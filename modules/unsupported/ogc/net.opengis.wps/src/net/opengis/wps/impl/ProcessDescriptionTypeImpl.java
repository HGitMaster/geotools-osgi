 ...
 * </copyright>
 *
 * $Id: ProcessDescriptionTypeImpl.java 29861 2008-04-09 04:55:54Z jdeolive $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.impl.ProcessDescriptionTypeImpl#getDataInputs <em>Data Inputs</em>}</li>
 *   <li>{@link net.opengis.wps.impl.ProcessDescriptionTypeImpl#getProcessOutputs <em>Process Outputs</em>}</li>
 *   <li>{@link net.opengis.wps.impl.ProcessDescriptionTypeImpl#isStatusSupported <em>Status Supported</em>}</li>
 *   <li>{@link net.opengis.wps.impl.ProcessDescriptionTypeImpl#isStoreSupported <em>Store Supported</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessDescriptionTypeImpl extends ProcessBriefTypeImpl implements ProcessDescriptionType {
	...
	protected EClass eStaticClass() {
		return WpsPackage.eINSTANCE.getProcessDescriptionType();
	}
	...
	public NotificationChain basicSetDataInputs(DataInputsType newDataInputs, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WpsPackage.PROCESS_DESCRIPTION_TYPE__DATA_INPUTS, oldDataInputs, newDataInputs);
	...
	public void setDataInputs(DataInputsType newDataInputs) {
		if (newDataInputs != dataInputs) {
			...
			if (dataInputs != null)
				msgs = ((InternalEObject)dataInputs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WpsPackage.PROCESS_DESCRIPTION_TYPE__DATA_INPUTS, null, msgs);
			if (newDataInputs != null)
				msgs = ((InternalEObject)newDataInputs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WpsPackage.PROCESS_DESCRIPTION_TYPE__DATA_INPUTS, null, msgs);
			msgs = basicSetDataInputs(newDataInputs, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.PROCESS_DESCRIPTION_TYPE__DATA_INPUTS, newDataInputs, newDataInputs));
	}
	...
	public NotificationChain basicSetProcessOutputs(ProcessOutputsType newProcessOutputs, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WpsPackage.PROCESS_DESCRIPTION_TYPE__PROCESS_OUTPUTS, oldProcessOutputs, newProcessOutputs);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProcessOutputs(ProcessOutputsType newProcessOutputs) {
		if (newProcessOutputs != processOutputs) {
			...
			if (processOutputs != null)
				msgs = ((InternalEObject)processOutputs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WpsPackage.PROCESS_DESCRIPTION_TYPE__PROCESS_OUTPUTS, null, msgs);
			if (newProcessOutputs != null)
				msgs = ((InternalEObject)newProcessOutputs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WpsPackage.PROCESS_DESCRIPTION_TYPE__PROCESS_OUTPUTS, null, msgs);
			msgs = basicSetProcessOutputs(newProcessOutputs, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.PROCESS_DESCRIPTION_TYPE__PROCESS_OUTPUTS, newProcessOutputs, newProcessOutputs));
	}
	...
	public void setStatusSupported(boolean newStatusSupported) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.PROCESS_DESCRIPTION_TYPE__STATUS_SUPPORTED, oldStatusSupported, statusSupported, !oldStatusSupportedESet));
	}
	...
	public void unsetStatusSupported() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WpsPackage.PROCESS_DESCRIPTION_TYPE__STATUS_SUPPORTED, oldStatusSupported, STATUS_SUPPORTED_EDEFAULT, oldStatusSupportedESet));
	}
	...
	public void setStoreSupported(boolean newStoreSupported) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.PROCESS_DESCRIPTION_TYPE__STORE_SUPPORTED, oldStoreSupported, storeSupported, !oldStoreSupportedESet));
	}
	...
	public void unsetStoreSupported() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WpsPackage.PROCESS_DESCRIPTION_TYPE__STORE_SUPPORTED, oldStoreSupported, STORE_SUPPORTED_EDEFAULT, oldStoreSupportedESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WpsPackage.PROCESS_DESCRIPTION_TYPE__DATA_INPUTS:
				return basicSetDataInputs(null, msgs);
			case WpsPackage.PROCESS_DESCRIPTION_TYPE__PROCESS_OUTPUTS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WpsPackage.PROCESS_DESCRIPTION_TYPE__STATUS_SUPPORTED:
				return isStatusSupported() ? Boolean.TRUE : Boolean.FALSE;
			case WpsPackage.PROCESS_DESCRIPTION_TYPE__STORE_SUPPORTED:
