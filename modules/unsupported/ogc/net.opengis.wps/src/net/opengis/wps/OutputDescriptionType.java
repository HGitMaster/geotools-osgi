 ...
 * </copyright>
 *
 * $Id: OutputDescriptionType.java 30488 2008-06-02 23:31:41Z gdavis $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.OutputDescriptionType#getComplexOutput <em>Complex Output</em>}</li>
 *   <li>{@link net.opengis.wps.OutputDescriptionType#getLiteralOutput <em>Literal Output</em>}</li>
 *   <li>{@link net.opengis.wps.OutputDescriptionType#getBoundingBoxOutput <em>Bounding Box Output</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wps.WpsPackage#getOutputDescriptionType()
...
public interface OutputDescriptionType extends DescriptionType {
	 ...
	 * @see net.opengis.wps.WpsPackage#getOutputDescriptionType_ComplexOutput()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.OutputDescriptionType#getComplexOutput <em>Complex Output</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getOutputDescriptionType_LiteralOutput()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.OutputDescriptionType#getLiteralOutput <em>Literal Output</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getOutputDescriptionType_BoundingBoxOutput()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.OutputDescriptionType#getBoundingBoxOutput <em>Bounding Box Output</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
