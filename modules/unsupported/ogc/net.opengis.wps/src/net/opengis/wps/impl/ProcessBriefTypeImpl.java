 ...
 * </copyright>
 *
 * $Id: ProcessBriefTypeImpl.java 30488 2008-06-02 23:31:41Z gdavis $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.impl.ProcessBriefTypeImpl#getProfile <em>Profile</em>}</li>
 *   <li>{@link net.opengis.wps.impl.ProcessBriefTypeImpl#getWSDL <em>WSDL</em>}</li>
 *   <li>{@link net.opengis.wps.impl.ProcessBriefTypeImpl#getProcessVersion <em>Process Version</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessBriefTypeImpl extends DescriptionTypeImpl implements ProcessBriefType {
	...
	protected EClass eStaticClass() {
		return WpsPackage.eINSTANCE.getProcessBriefType();
	}
	...
	public NotificationChain basicSetWSDL(WSDLType newWSDL, NotificationChain msgs) {
		...
		wSDL = newWSDL;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WpsPackage.PROCESS_BRIEF_TYPE__WSDL, oldWSDL, newWSDL);
	...
	public void setWSDL(WSDLType newWSDL) {
		if (newWSDL != wSDL) {
			...
			if (wSDL != null)
				msgs = ((InternalEObject)wSDL).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WpsPackage.PROCESS_BRIEF_TYPE__WSDL, null, msgs);
			if (newWSDL != null)
				msgs = ((InternalEObject)newWSDL).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WpsPackage.PROCESS_BRIEF_TYPE__WSDL, null, msgs);
			msgs = basicSetWSDL(newWSDL, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.PROCESS_BRIEF_TYPE__WSDL, newWSDL, newWSDL));
	}
	...
	public void setProcessVersion(String newProcessVersion) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.PROCESS_BRIEF_TYPE__PROCESS_VERSION, oldProcessVersion, processVersion));
	}
