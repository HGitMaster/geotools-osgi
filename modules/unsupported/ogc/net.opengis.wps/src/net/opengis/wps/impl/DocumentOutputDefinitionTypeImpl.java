 ...
 * </copyright>
 *
 * $Id: DocumentOutputDefinitionTypeImpl.java 29861 2008-04-09 04:55:54Z jdeolive $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.impl.DocumentOutputDefinitionTypeImpl#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.wps.impl.DocumentOutputDefinitionTypeImpl#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link net.opengis.wps.impl.DocumentOutputDefinitionTypeImpl#isAsReference <em>As Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentOutputDefinitionTypeImpl extends OutputDefinitionTypeImpl implements DocumentOutputDefinitionType {
	...
	protected EClass eStaticClass() {
		return WpsPackage.eINSTANCE.getDocumentOutputDefinitionType();
	}
	...
	public NotificationChain basicSetTitle(LanguageStringType newTitle, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WpsPackage.DOCUMENT_OUTPUT_DEFINITION_TYPE__TITLE, oldTitle, newTitle);
	...
	public void setTitle(LanguageStringType newTitle) {
		if (newTitle != title) {
			...
			if (title != null)
				msgs = ((InternalEObject)title).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WpsPackage.DOCUMENT_OUTPUT_DEFINITION_TYPE__TITLE, null, msgs);
			if (newTitle != null)
				msgs = ((InternalEObject)newTitle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WpsPackage.DOCUMENT_OUTPUT_DEFINITION_TYPE__TITLE, null, msgs);
			msgs = basicSetTitle(newTitle, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.DOCUMENT_OUTPUT_DEFINITION_TYPE__TITLE, newTitle, newTitle));
	}
	...
	public NotificationChain basicSetAbstract(LanguageStringType newAbstract, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WpsPackage.DOCUMENT_OUTPUT_DEFINITION_TYPE__ABSTRACT, oldAbstract, newAbstract);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setAbstract(LanguageStringType newAbstract) {
		if (newAbstract != abstract_) {
			NotificationChain msgs = null;
			if (abstract_ != null)
				msgs = ((InternalEObject)abstract_).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WpsPackage.DOCUMENT_OUTPUT_DEFINITION_TYPE__ABSTRACT, null, msgs);
			if (newAbstract != null)
				msgs = ((InternalEObject)newAbstract).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WpsPackage.DOCUMENT_OUTPUT_DEFINITION_TYPE__ABSTRACT, null, msgs);
			msgs = basicSetAbstract(newAbstract, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.DOCUMENT_OUTPUT_DEFINITION_TYPE__ABSTRACT, newAbstract, newAbstract));
	}
	...
	public void setAsReference(boolean newAsReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.DOCUMENT_OUTPUT_DEFINITION_TYPE__AS_REFERENCE, oldAsReference, asReference, !oldAsReferenceESet));
	}
	...
	public void unsetAsReference() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WpsPackage.DOCUMENT_OUTPUT_DEFINITION_TYPE__AS_REFERENCE, oldAsReference, AS_REFERENCE_EDEFAULT, oldAsReferenceESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WpsPackage.DOCUMENT_OUTPUT_DEFINITION_TYPE__TITLE:
				return basicSetTitle(null, msgs);
			case WpsPackage.DOCUMENT_OUTPUT_DEFINITION_TYPE__ABSTRACT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WpsPackage.DOCUMENT_OUTPUT_DEFINITION_TYPE__ABSTRACT:
				return getAbstract();
			case WpsPackage.DOCUMENT_OUTPUT_DEFINITION_TYPE__AS_REFERENCE:
