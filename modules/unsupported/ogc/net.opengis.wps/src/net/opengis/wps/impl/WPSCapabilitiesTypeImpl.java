 ...
 * </copyright>
 *
 * $Id: WPSCapabilitiesTypeImpl.java 29861 2008-04-09 04:55:54Z jdeolive $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.impl.WPSCapabilitiesTypeImpl#getProcessOfferings <em>Process Offerings</em>}</li>
 *   <li>{@link net.opengis.wps.impl.WPSCapabilitiesTypeImpl#getLanguages <em>Languages</em>}</li>
 *   <li>{@link net.opengis.wps.impl.WPSCapabilitiesTypeImpl#getWSDL <em>WSDL</em>}</li>
 *   <li>{@link net.opengis.wps.impl.WPSCapabilitiesTypeImpl#getService <em>Service</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class WPSCapabilitiesTypeImpl extends CapabilitiesBaseTypeImpl implements WPSCapabilitiesType {
	...
	protected EClass eStaticClass() {
		return WpsPackage.eINSTANCE.getWPSCapabilitiesType();
	}
	...
	public NotificationChain basicSetProcessOfferings(ProcessOfferingsType newProcessOfferings, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WpsPackage.WPS_CAPABILITIES_TYPE__PROCESS_OFFERINGS, oldProcessOfferings, newProcessOfferings);
	...
	public void setProcessOfferings(ProcessOfferingsType newProcessOfferings) {
		if (newProcessOfferings != processOfferings) {
			...
			if (processOfferings != null)
				msgs = ((InternalEObject)processOfferings).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WpsPackage.WPS_CAPABILITIES_TYPE__PROCESS_OFFERINGS, null, msgs);
			if (newProcessOfferings != null)
				msgs = ((InternalEObject)newProcessOfferings).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WpsPackage.WPS_CAPABILITIES_TYPE__PROCESS_OFFERINGS, null, msgs);
			msgs = basicSetProcessOfferings(newProcessOfferings, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.WPS_CAPABILITIES_TYPE__PROCESS_OFFERINGS, newProcessOfferings, newProcessOfferings));
	}
	...
	public NotificationChain basicSetLanguages(LanguagesType1 newLanguages, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WpsPackage.WPS_CAPABILITIES_TYPE__LANGUAGES, oldLanguages, newLanguages);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setLanguages(LanguagesType1 newLanguages) {
		if (newLanguages != languages) {
			NotificationChain msgs = null;
			if (languages != null)
				msgs = ((InternalEObject)languages).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WpsPackage.WPS_CAPABILITIES_TYPE__LANGUAGES, null, msgs);
			if (newLanguages != null)
				msgs = ((InternalEObject)newLanguages).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WpsPackage.WPS_CAPABILITIES_TYPE__LANGUAGES, null, msgs);
			msgs = basicSetLanguages(newLanguages, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.WPS_CAPABILITIES_TYPE__LANGUAGES, newLanguages, newLanguages));
	}
	...
	public NotificationChain basicSetWSDL(WSDLType newWSDL, NotificationChain msgs) {
		...
		wSDL = newWSDL;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WpsPackage.WPS_CAPABILITIES_TYPE__WSDL, oldWSDL, newWSDL);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setWSDL(WSDLType newWSDL) {
		if (newWSDL != wSDL) {
			NotificationChain msgs = null;
			if (wSDL != null)
				msgs = ((InternalEObject)wSDL).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WpsPackage.WPS_CAPABILITIES_TYPE__WSDL, null, msgs);
			if (newWSDL != null)
				msgs = ((InternalEObject)newWSDL).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WpsPackage.WPS_CAPABILITIES_TYPE__WSDL, null, msgs);
			msgs = basicSetWSDL(newWSDL, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.WPS_CAPABILITIES_TYPE__WSDL, newWSDL, newWSDL));
	}
	...
	public void setService(Object newService) {
		...
		serviceESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.WPS_CAPABILITIES_TYPE__SERVICE, oldService, service, !oldServiceESet));
	}
	...
	public void unsetService() {
		...
		serviceESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WpsPackage.WPS_CAPABILITIES_TYPE__SERVICE, oldService, SERVICE_EDEFAULT, oldServiceESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case WpsPackage.WPS_CAPABILITIES_TYPE__LANGUAGES:
				return basicSetLanguages(null, msgs);
			case WpsPackage.WPS_CAPABILITIES_TYPE__WSDL:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WpsPackage.WPS_CAPABILITIES_TYPE__WSDL:
				return getWSDL();
			case WpsPackage.WPS_CAPABILITIES_TYPE__SERVICE:
				return getService();
		}
