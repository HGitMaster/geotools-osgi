 ...
 * </copyright>
 *
 * $Id: InputReferenceType.java 30488 2008-06-02 23:31:41Z gdavis $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.InputReferenceType#getHeader <em>Header</em>}</li>
 *   <li>{@link net.opengis.wps.InputReferenceType#getBody <em>Body</em>}</li>
 *   <li>{@link net.opengis.wps.InputReferenceType#getBodyReference <em>Body Reference</em>}</li>
 *   <li>{@link net.opengis.wps.InputReferenceType#getEncoding <em>Encoding</em>}</li>
 *   <li>{@link net.opengis.wps.InputReferenceType#getHref <em>Href</em>}</li>
 *   <li>{@link net.opengis.wps.InputReferenceType#getMethod <em>Method</em>}</li>
 *   <li>{@link net.opengis.wps.InputReferenceType#getMimeType <em>Mime Type</em>}</li>
 *   <li>{@link net.opengis.wps.InputReferenceType#getSchema <em>Schema</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wps.WpsPackage#getInputReferenceType()
...
public interface InputReferenceType extends EObject {
	 ...
	 * The list contents are of type {@link net.opengis.wps.HeaderType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getInputReferenceType_Header()
	 * @model type="net.opengis.wps.HeaderType" containment="true"
	 ...
	 * @see #setBody(EObject)
	 * @see net.opengis.wps.WpsPackage#getInputReferenceType_Body()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.InputReferenceType#getBody <em>Body</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getInputReferenceType_BodyReference()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.InputReferenceType#getBodyReference <em>Body Reference</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getInputReferenceType_Encoding()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.InputReferenceType#getEncoding <em>Encoding</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setHref(String)
	 * @see net.opengis.wps.WpsPackage#getInputReferenceType_Href()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.InputReferenceType#getHref <em>Href</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link net.opengis.wps.MethodType}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getInputReferenceType_Method()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.InputReferenceType#getMethod <em>Method</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.wps.InputReferenceType#getMethod <em>Method</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetMethod()
	 * @see #getMethod()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.wps.InputReferenceType#getMethod <em>Method</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getInputReferenceType_MimeType()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.InputReferenceType#getMimeType <em>Mime Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getInputReferenceType_Schema()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.AnyURI"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.InputReferenceType#getSchema <em>Schema</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
