 ...
 * </copyright>
 *
 * $Id: ValuesReferenceTypeImpl.java 29861 2008-04-09 04:55:54Z jdeolive $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.impl.ValuesReferenceTypeImpl#getReference <em>Reference</em>}</li>
 *   <li>{@link net.opengis.wps.impl.ValuesReferenceTypeImpl#getValuesForm <em>Values Form</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ValuesReferenceTypeImpl extends EObjectImpl implements ValuesReferenceType {
	...
	protected EClass eStaticClass() {
		return WpsPackage.eINSTANCE.getValuesReferenceType();
	}
	...
	public void setReference(String newReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.VALUES_REFERENCE_TYPE__REFERENCE, oldReference, reference));
	}
	...
	public void setValuesForm(String newValuesForm) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.VALUES_REFERENCE_TYPE__VALUES_FORM, oldValuesForm, valuesForm));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WpsPackage.VALUES_REFERENCE_TYPE__REFERENCE:
				return getReference();
			case WpsPackage.VALUES_REFERENCE_TYPE__VALUES_FORM:
