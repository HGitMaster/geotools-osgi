 ...
 * </copyright>
 *
 * $Id: ProcessFailedTypeImpl.java 29861 2008-04-09 04:55:54Z jdeolive $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.impl.ProcessFailedTypeImpl#getExceptionReport <em>Exception Report</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessFailedTypeImpl extends EObjectImpl implements ProcessFailedType {
	...
	protected EClass eStaticClass() {
		return WpsPackage.eINSTANCE.getProcessFailedType();
	}
	...
	public NotificationChain basicSetExceptionReport(ExceptionReportType newExceptionReport, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WpsPackage.PROCESS_FAILED_TYPE__EXCEPTION_REPORT, oldExceptionReport, newExceptionReport);
	...
	public void setExceptionReport(ExceptionReportType newExceptionReport) {
		if (newExceptionReport != exceptionReport) {
			...
			if (exceptionReport != null)
				msgs = ((InternalEObject)exceptionReport).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WpsPackage.PROCESS_FAILED_TYPE__EXCEPTION_REPORT, null, msgs);
			if (newExceptionReport != null)
				msgs = ((InternalEObject)newExceptionReport).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WpsPackage.PROCESS_FAILED_TYPE__EXCEPTION_REPORT, null, msgs);
			msgs = basicSetExceptionReport(newExceptionReport, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.PROCESS_FAILED_TYPE__EXCEPTION_REPORT, newExceptionReport, newExceptionReport));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WpsPackage.PROCESS_FAILED_TYPE__EXCEPTION_REPORT:
