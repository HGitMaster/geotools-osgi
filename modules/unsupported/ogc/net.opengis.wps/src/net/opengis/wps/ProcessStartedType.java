 ...
 * </copyright>
 *
 * $Id: ProcessStartedType.java 30488 2008-06-02 23:31:41Z gdavis $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.ProcessStartedType#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.wps.ProcessStartedType#getPercentCompleted <em>Percent Completed</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wps.WpsPackage#getProcessStartedType()
...
public interface ProcessStartedType extends EObject {
	 ...
	 * @see #setValue(String)
	 * @see net.opengis.wps.WpsPackage#getProcessStartedType_Value()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.ProcessStartedType#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getProcessStartedType_PercentCompleted()
	 * @model dataType="net.opengis.wps.PercentCompletedType"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.ProcessStartedType#getPercentCompleted <em>Percent Completed</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
