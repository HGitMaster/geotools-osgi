 ...
 * </copyright>
 *
 * $Id: DescriptionType.java 30488 2008-06-02 23:31:41Z gdavis $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.DescriptionType#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link net.opengis.wps.DescriptionType#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.wps.DescriptionType#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link net.opengis.wps.DescriptionType#getMetadata <em>Metadata</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wps.WpsPackage#getDescriptionType()
...
public interface DescriptionType extends EObject {
	 ...
	 * @see net.opengis.wps.WpsPackage#getDescriptionType_Identifier()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.DescriptionType#getIdentifier <em>Identifier</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getDescriptionType_Title()
	 * @model containment="true" required="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.DescriptionType#getTitle <em>Title</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getDescriptionType_Abstract()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.DescriptionType#getAbstract <em>Abstract</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
