 ...
 * </copyright>
 *
 * $Id: ResponseFormType.java 29861 2008-04-09 04:55:54Z jdeolive $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.ResponseFormType#getResponseDocument <em>Response Document</em>}</li>
 *   <li>{@link net.opengis.wps.ResponseFormType#getRawDataOutput <em>Raw Data Output</em>}</li>
 * </ul>
 * </p>
 *
...
public interface ResponseFormType extends EObject {
	 ...
	 * @see net.opengis.wps.WpsPackage#getResponseFormType_ResponseDocument()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.ResponseFormType#getResponseDocument <em>Response Document</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getResponseFormType_RawDataOutput()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.ResponseFormType#getRawDataOutput <em>Raw Data Output</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
