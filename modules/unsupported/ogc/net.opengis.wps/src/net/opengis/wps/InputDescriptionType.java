 ...
 * </copyright>
 *
 * $Id: InputDescriptionType.java 30488 2008-06-02 23:31:41Z gdavis $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.InputDescriptionType#getComplexData <em>Complex Data</em>}</li>
 *   <li>{@link net.opengis.wps.InputDescriptionType#getLiteralData <em>Literal Data</em>}</li>
 *   <li>{@link net.opengis.wps.InputDescriptionType#getBoundingBoxData <em>Bounding Box Data</em>}</li>
 *   <li>{@link net.opengis.wps.InputDescriptionType#getMaxOccurs <em>Max Occurs</em>}</li>
 *   <li>{@link net.opengis.wps.InputDescriptionType#getMinOccurs <em>Min Occurs</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wps.WpsPackage#getInputDescriptionType()
...
public interface InputDescriptionType extends DescriptionType {
	 ...
	 * @see net.opengis.wps.WpsPackage#getInputDescriptionType_ComplexData()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.InputDescriptionType#getComplexData <em>Complex Data</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getInputDescriptionType_LiteralData()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.InputDescriptionType#getLiteralData <em>Literal Data</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getInputDescriptionType_BoundingBoxData()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.InputDescriptionType#getBoundingBoxData <em>Bounding Box Data</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getInputDescriptionType_MaxOccurs()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.InputDescriptionType#getMaxOccurs <em>Max Occurs</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getInputDescriptionType_MinOccurs()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.InputDescriptionType#getMinOccurs <em>Min Occurs</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
