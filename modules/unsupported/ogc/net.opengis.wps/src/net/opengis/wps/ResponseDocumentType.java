 ...
 * </copyright>
 *
 * $Id: ResponseDocumentType.java 30488 2008-06-02 23:31:41Z gdavis $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.ResponseDocumentType#getOutput <em>Output</em>}</li>
 *   <li>{@link net.opengis.wps.ResponseDocumentType#isLineage <em>Lineage</em>}</li>
 *   <li>{@link net.opengis.wps.ResponseDocumentType#isStatus <em>Status</em>}</li>
 *   <li>{@link net.opengis.wps.ResponseDocumentType#isStoreExecuteResponse <em>Store Execute Response</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wps.WpsPackage#getResponseDocumentType()
...
public interface ResponseDocumentType extends EObject {
	 ...
	 * @see net.opengis.wps.WpsPackage#getResponseDocumentType_Lineage()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.ResponseDocumentType#isLineage <em>Lineage</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.wps.ResponseDocumentType#isLineage <em>Lineage</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetLineage()
	 * @see #isLineage()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.wps.ResponseDocumentType#isLineage <em>Lineage</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getResponseDocumentType_Status()
	 * @model default="false" unsettable="true" dataType="org.eclipse.emf.ecore.xml.type.Boolean"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.ResponseDocumentType#isStatus <em>Status</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.wps.ResponseDocumentType#isStatus <em>Status</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetStatus()
	 * @see #isStatus()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.wps.ResponseDocumentType#isStatus <em>Status</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getResponseDocumentType_StoreExecuteResponse()
	 * @model default="false" unsettable="true" dataType="org.eclipse.emf.ecore.xml.type.Boolean"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.ResponseDocumentType#isStoreExecuteResponse <em>Store Execute Response</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.wps.ResponseDocumentType#isStoreExecuteResponse <em>Store Execute Response</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetStoreExecuteResponse()
	 * @see #isStoreExecuteResponse()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.wps.ResponseDocumentType#isStoreExecuteResponse <em>Store Execute Response</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
