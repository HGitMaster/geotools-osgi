 ...
 * </copyright>
 *
 * $Id: DataInputsType1Impl.java 29861 2008-04-09 04:55:54Z jdeolive $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.impl.DataInputsType1Impl#getInput <em>Input</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataInputsType1Impl extends EObjectImpl implements DataInputsType1 {
	...
	protected EClass eStaticClass() {
		return WpsPackage.eINSTANCE.getDataInputsType1();
	}
	...
	public EList getInput() {
		if (input == null) {
			input = new EObjectContainmentEList(InputType.class, this, WpsPackage.DATA_INPUTS_TYPE1__INPUT);
		}
		return input;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WpsPackage.DATA_INPUTS_TYPE1__INPUT:
