 ...
 * </copyright>
 *
 * $Id: ResponseDocumentTypeImpl.java 29861 2008-04-09 04:55:54Z jdeolive $
 */
...
import net.opengis.wps.ResponseDocumentType;
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.impl.ResponseDocumentTypeImpl#getOutput <em>Output</em>}</li>
 *   <li>{@link net.opengis.wps.impl.ResponseDocumentTypeImpl#isLineage <em>Lineage</em>}</li>
 *   <li>{@link net.opengis.wps.impl.ResponseDocumentTypeImpl#isStatus <em>Status</em>}</li>
 *   <li>{@link net.opengis.wps.impl.ResponseDocumentTypeImpl#isStoreExecuteResponse <em>Store Execute Response</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResponseDocumentTypeImpl extends EObjectImpl implements ResponseDocumentType {
	...
	protected EClass eStaticClass() {
		return WpsPackage.eINSTANCE.getResponseDocumentType();
	}
	...
	public EList getOutput() {
		if (output == null) {
			output = new EObjectContainmentEList(DocumentOutputDefinitionType.class, this, WpsPackage.RESPONSE_DOCUMENT_TYPE__OUTPUT);
		}
		return output;
	}
	...
	public void setLineage(boolean newLineage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.RESPONSE_DOCUMENT_TYPE__LINEAGE, oldLineage, lineage, !oldLineageESet));
	}
	...
	public void unsetLineage() {
		...
		lineageESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WpsPackage.RESPONSE_DOCUMENT_TYPE__LINEAGE, oldLineage, LINEAGE_EDEFAULT, oldLineageESet));
	}
	...
	public void setStatus(boolean newStatus) {
		...
		statusESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.RESPONSE_DOCUMENT_TYPE__STATUS, oldStatus, status, !oldStatusESet));
	}
	...
	public void unsetStatus() {
		...
		statusESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WpsPackage.RESPONSE_DOCUMENT_TYPE__STATUS, oldStatus, STATUS_EDEFAULT, oldStatusESet));
	}
	...
	public void setStoreExecuteResponse(boolean newStoreExecuteResponse) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.RESPONSE_DOCUMENT_TYPE__STORE_EXECUTE_RESPONSE, oldStoreExecuteResponse, storeExecuteResponse, !oldStoreExecuteResponseESet));
	}
	...
	public void unsetStoreExecuteResponse() {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WpsPackage.RESPONSE_DOCUMENT_TYPE__STORE_EXECUTE_RESPONSE, oldStoreExecuteResponse, STORE_EXECUTE_RESPONSE_EDEFAULT, oldStoreExecuteResponseESet));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WpsPackage.RESPONSE_DOCUMENT_TYPE__OUTPUT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WpsPackage.RESPONSE_DOCUMENT_TYPE__OUTPUT:
				return getOutput();
			case WpsPackage.RESPONSE_DOCUMENT_TYPE__LINEAGE:
				return isLineage() ? Boolean.TRUE : Boolean.FALSE;
			case WpsPackage.RESPONSE_DOCUMENT_TYPE__STATUS:
				return isStatus() ? Boolean.TRUE : Boolean.FALSE;
			case WpsPackage.RESPONSE_DOCUMENT_TYPE__STORE_EXECUTE_RESPONSE:
