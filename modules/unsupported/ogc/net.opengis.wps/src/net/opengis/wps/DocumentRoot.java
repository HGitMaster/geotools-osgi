 ...
 * </copyright>
 *
 * $Id: DocumentRoot.java 30488 2008-06-02 23:31:41Z gdavis $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.DocumentRoot#getMixed <em>Mixed</em>}</li>
 *   <li>{@link net.opengis.wps.DocumentRoot#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link net.opengis.wps.DocumentRoot#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link net.opengis.wps.DocumentRoot#getCapabilities <em>Capabilities</em>}</li>
 *   <li>{@link net.opengis.wps.DocumentRoot#getDescribeProcess <em>Describe Process</em>}</li>
 *   <li>{@link net.opengis.wps.DocumentRoot#getExecute <em>Execute</em>}</li>
 *   <li>{@link net.opengis.wps.DocumentRoot#getExecuteResponse <em>Execute Response</em>}</li>
 *   <li>{@link net.opengis.wps.DocumentRoot#getGetCapabilities <em>Get Capabilities</em>}</li>
 *   <li>{@link net.opengis.wps.DocumentRoot#getLanguages <em>Languages</em>}</li>
 *   <li>{@link net.opengis.wps.DocumentRoot#getProcessDescriptions <em>Process Descriptions</em>}</li>
 *   <li>{@link net.opengis.wps.DocumentRoot#getProcessOfferings <em>Process Offerings</em>}</li>
 *   <li>{@link net.opengis.wps.DocumentRoot#getWSDL <em>WSDL</em>}</li>
 *   <li>{@link net.opengis.wps.DocumentRoot#getProcessVersion <em>Process Version</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wps.WpsPackage#getDocumentRoot()
...
public interface DocumentRoot extends EObject {
	 ...
	 * @see net.opengis.wps.WpsPackage#getDocumentRoot_Mixed()
	 ...
	 * @see net.opengis.wps.WpsPackage#getDocumentRoot_XMLNSPrefixMap()
	 ...
	 * @see net.opengis.wps.WpsPackage#getDocumentRoot_XSISchemaLocation()
	 * @model mapType="org.eclipse.emf.ecore.EStringToStringMapEntry" keyType="java.lang.String" valueType="java.lang.String" transient="true"
	 ...
	 * @see net.opengis.wps.WpsPackage#getDocumentRoot_Capabilities()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.DocumentRoot#getCapabilities <em>Capabilities</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getDocumentRoot_DescribeProcess()
	 * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.DocumentRoot#getDescribeProcess <em>Describe Process</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getDocumentRoot_Execute()
	 * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.DocumentRoot#getExecute <em>Execute</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getDocumentRoot_ExecuteResponse()
	 * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.DocumentRoot#getExecuteResponse <em>Execute Response</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getDocumentRoot_GetCapabilities()
	 * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.DocumentRoot#getGetCapabilities <em>Get Capabilities</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getDocumentRoot_Languages()
	 * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.DocumentRoot#getLanguages <em>Languages</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getDocumentRoot_ProcessDescriptions()
	 * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.DocumentRoot#getProcessDescriptions <em>Process Descriptions</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getDocumentRoot_ProcessOfferings()
	 * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.DocumentRoot#getProcessOfferings <em>Process Offerings</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getDocumentRoot_WSDL()
	 * @model containment="true" upper="-2" transient="true" volatile="true" derived="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.DocumentRoot#getWSDL <em>WSDL</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getDocumentRoot_ProcessVersion()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.DocumentRoot#getProcessVersion <em>Process Version</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
