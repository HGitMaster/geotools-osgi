 ...
 * </copyright>
 *
 * $Id: DataInputsTypeImpl.java 29861 2008-04-09 04:55:54Z jdeolive $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.impl.DataInputsTypeImpl#getInput <em>Input</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataInputsTypeImpl extends EObjectImpl implements DataInputsType {
	...
	protected EClass eStaticClass() {
		return WpsPackage.eINSTANCE.getDataInputsType();
	}
	...
	public EList getInput() {
		if (input == null) {
			input = new EObjectContainmentEList(InputDescriptionType.class, this, WpsPackage.DATA_INPUTS_TYPE__INPUT);
		}
		return input;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WpsPackage.DATA_INPUTS_TYPE__INPUT:
