 ...
 * </copyright>
 *
 * $Id: ProcessDescriptionType.java 30488 2008-06-02 23:31:41Z gdavis $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.ProcessDescriptionType#getDataInputs <em>Data Inputs</em>}</li>
 *   <li>{@link net.opengis.wps.ProcessDescriptionType#getProcessOutputs <em>Process Outputs</em>}</li>
 *   <li>{@link net.opengis.wps.ProcessDescriptionType#isStatusSupported <em>Status Supported</em>}</li>
 *   <li>{@link net.opengis.wps.ProcessDescriptionType#isStoreSupported <em>Store Supported</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wps.WpsPackage#getProcessDescriptionType()
...
public interface ProcessDescriptionType extends ProcessBriefType {
	 ...
	 * @see net.opengis.wps.WpsPackage#getProcessDescriptionType_DataInputs()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.ProcessDescriptionType#getDataInputs <em>Data Inputs</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getProcessDescriptionType_ProcessOutputs()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.ProcessDescriptionType#getProcessOutputs <em>Process Outputs</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getProcessDescriptionType_StatusSupported()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.ProcessDescriptionType#isStatusSupported <em>Status Supported</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.wps.ProcessDescriptionType#isStatusSupported <em>Status Supported</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetStatusSupported()
	 * @see #isStatusSupported()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.wps.ProcessDescriptionType#isStatusSupported <em>Status Supported</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getProcessDescriptionType_StoreSupported()
	 * @model default="false" unsettable="true" dataType="org.eclipse.emf.ecore.xml.type.Boolean"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.ProcessDescriptionType#isStoreSupported <em>Store Supported</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Unsets the value of the '{@link net.opengis.wps.ProcessDescriptionType#isStoreSupported <em>Store Supported</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #isSetStoreSupported()
	 * @see #isStoreSupported()
	...
	/**
	 * Returns whether the value of the '{@link net.opengis.wps.ProcessDescriptionType#isStoreSupported <em>Store Supported</em>}' attribute is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
