 ...
 * </copyright>
 *
 * $Id: InputType.java 30488 2008-06-02 23:31:41Z gdavis $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.InputType#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link net.opengis.wps.InputType#getTitle <em>Title</em>}</li>
 *   <li>{@link net.opengis.wps.InputType#getAbstract <em>Abstract</em>}</li>
 *   <li>{@link net.opengis.wps.InputType#getReference <em>Reference</em>}</li>
 *   <li>{@link net.opengis.wps.InputType#getData <em>Data</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wps.WpsPackage#getInputType()
...
public interface InputType extends EObject {
	 ...
	 * @see net.opengis.wps.WpsPackage#getInputType_Identifier()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.InputType#getIdentifier <em>Identifier</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getInputType_Title()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.InputType#getTitle <em>Title</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getInputType_Abstract()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.InputType#getAbstract <em>Abstract</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getInputType_Reference()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.InputType#getReference <em>Reference</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getInputType_Data()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.InputType#getData <em>Data</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
