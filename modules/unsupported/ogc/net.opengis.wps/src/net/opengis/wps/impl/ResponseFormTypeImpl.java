 ...
 * </copyright>
 *
 * $Id: ResponseFormTypeImpl.java 29861 2008-04-09 04:55:54Z jdeolive $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.impl.ResponseFormTypeImpl#getResponseDocument <em>Response Document</em>}</li>
 *   <li>{@link net.opengis.wps.impl.ResponseFormTypeImpl#getRawDataOutput <em>Raw Data Output</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ResponseFormTypeImpl extends EObjectImpl implements ResponseFormType {
	...
	protected EClass eStaticClass() {
		return WpsPackage.eINSTANCE.getResponseFormType();
	}
	...
	public NotificationChain basicSetResponseDocument(ResponseDocumentType newResponseDocument, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WpsPackage.RESPONSE_FORM_TYPE__RESPONSE_DOCUMENT, oldResponseDocument, newResponseDocument);
	...
	public void setResponseDocument(ResponseDocumentType newResponseDocument) {
		if (newResponseDocument != responseDocument) {
			...
			if (responseDocument != null)
				msgs = ((InternalEObject)responseDocument).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WpsPackage.RESPONSE_FORM_TYPE__RESPONSE_DOCUMENT, null, msgs);
			if (newResponseDocument != null)
				msgs = ((InternalEObject)newResponseDocument).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WpsPackage.RESPONSE_FORM_TYPE__RESPONSE_DOCUMENT, null, msgs);
			msgs = basicSetResponseDocument(newResponseDocument, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.RESPONSE_FORM_TYPE__RESPONSE_DOCUMENT, newResponseDocument, newResponseDocument));
	}
	...
	public NotificationChain basicSetRawDataOutput(OutputDefinitionType newRawDataOutput, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WpsPackage.RESPONSE_FORM_TYPE__RAW_DATA_OUTPUT, oldRawDataOutput, newRawDataOutput);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setRawDataOutput(OutputDefinitionType newRawDataOutput) {
		if (newRawDataOutput != rawDataOutput) {
			...
			if (rawDataOutput != null)
				msgs = ((InternalEObject)rawDataOutput).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WpsPackage.RESPONSE_FORM_TYPE__RAW_DATA_OUTPUT, null, msgs);
			if (newRawDataOutput != null)
				msgs = ((InternalEObject)newRawDataOutput).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WpsPackage.RESPONSE_FORM_TYPE__RAW_DATA_OUTPUT, null, msgs);
			msgs = basicSetRawDataOutput(newRawDataOutput, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.RESPONSE_FORM_TYPE__RAW_DATA_OUTPUT, newRawDataOutput, newRawDataOutput));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WpsPackage.RESPONSE_FORM_TYPE__RESPONSE_DOCUMENT:
				return basicSetResponseDocument(null, msgs);
			case WpsPackage.RESPONSE_FORM_TYPE__RAW_DATA_OUTPUT:
