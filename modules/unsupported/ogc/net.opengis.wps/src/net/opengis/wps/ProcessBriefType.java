 ...
 * </copyright>
 *
 * $Id: ProcessBriefType.java 30488 2008-06-02 23:31:41Z gdavis $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.ProcessBriefType#getProfile <em>Profile</em>}</li>
 *   <li>{@link net.opengis.wps.ProcessBriefType#getWSDL <em>WSDL</em>}</li>
 *   <li>{@link net.opengis.wps.ProcessBriefType#getProcessVersion <em>Process Version</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wps.WpsPackage#getProcessBriefType()
...
public interface ProcessBriefType extends DescriptionType {
	 ...
	 * @see net.opengis.wps.WpsPackage#getProcessBriefType_WSDL()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.ProcessBriefType#getWSDL <em>WSDL</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getProcessBriefType_ProcessVersion()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.ProcessBriefType#getProcessVersion <em>Process Version</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
