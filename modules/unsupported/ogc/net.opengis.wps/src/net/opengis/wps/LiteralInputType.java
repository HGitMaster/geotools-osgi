 ...
 * </copyright>
 *
 * $Id: LiteralInputType.java 30488 2008-06-02 23:31:41Z gdavis $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.LiteralInputType#getAllowedValues <em>Allowed Values</em>}</li>
 *   <li>{@link net.opengis.wps.LiteralInputType#getAnyValue <em>Any Value</em>}</li>
 *   <li>{@link net.opengis.wps.LiteralInputType#getValuesReference <em>Values Reference</em>}</li>
 *   <li>{@link net.opengis.wps.LiteralInputType#getDefaultValue <em>Default Value</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wps.WpsPackage#getLiteralInputType()
...
public interface LiteralInputType extends LiteralOutputType {
	 ...
	 * @see net.opengis.wps.WpsPackage#getLiteralInputType_AllowedValues()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.LiteralInputType#getAllowedValues <em>Allowed Values</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getLiteralInputType_AnyValue()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.LiteralInputType#getAnyValue <em>Any Value</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getLiteralInputType_ValuesReference()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.LiteralInputType#getValuesReference <em>Values Reference</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getLiteralInputType_DefaultValue()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.LiteralInputType#getDefaultValue <em>Default Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
