 ...
 * </copyright>
 *
 * $Id: ProcessStartedTypeImpl.java 29861 2008-04-09 04:55:54Z jdeolive $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.impl.ProcessStartedTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.wps.impl.ProcessStartedTypeImpl#getPercentCompleted <em>Percent Completed</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ProcessStartedTypeImpl extends EObjectImpl implements ProcessStartedType {
	...
	protected EClass eStaticClass() {
		return WpsPackage.eINSTANCE.getProcessStartedType();
	}
	...
	public void setValue(String newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.PROCESS_STARTED_TYPE__VALUE, oldValue, value));
	}
	...
	public void setPercentCompleted(BigInteger newPercentCompleted) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.PROCESS_STARTED_TYPE__PERCENT_COMPLETED, oldPercentCompleted, percentCompleted));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WpsPackage.PROCESS_STARTED_TYPE__VALUE:
				return getValue();
			case WpsPackage.PROCESS_STARTED_TYPE__PERCENT_COMPLETED:
