 ...
 * </copyright>
 *
 * $Id: RequestBaseTypeImpl.java 30602 2008-06-10 22:53:33Z jdeolive $
 */
...
public class RequestBaseTypeImpl extends EObjectImpl implements RequestBaseType {
	...
	protected EClass eStaticClass() {
		return WpsPackage.eINSTANCE.getRequestBaseType();
	}
	...
	public void setLanguage(String newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.REQUEST_BASE_TYPE__LANGUAGE, oldLanguage, language));
	}
	...
	public void setService(String newService) {
		...
		serviceESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.REQUEST_BASE_TYPE__SERVICE, oldService, service, !oldServiceESet));
	}
	...
	public void unsetService() {
		...
		serviceESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WpsPackage.REQUEST_BASE_TYPE__SERVICE, oldService, SERVICE_EDEFAULT, oldServiceESet));
	}
	...
	public void setVersion(String newVersion) {
		...
		versionESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.REQUEST_BASE_TYPE__VERSION, oldVersion, version, !oldVersionESet));
	}
	...
	public void unsetVersion() {
		...
		versionESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, WpsPackage.REQUEST_BASE_TYPE__VERSION, oldVersion, VERSION_EDEFAULT, oldVersionESet));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case WpsPackage.REQUEST_BASE_TYPE__LANGUAGE:
				return getLanguage();
			case WpsPackage.REQUEST_BASE_TYPE__SERVICE:
				return getService();
