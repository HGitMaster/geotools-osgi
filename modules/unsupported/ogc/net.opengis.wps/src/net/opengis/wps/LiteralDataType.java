 ...
 * </copyright>
 *
 * $Id: LiteralDataType.java 30488 2008-06-02 23:31:41Z gdavis $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.LiteralDataType#getValue <em>Value</em>}</li>
 *   <li>{@link net.opengis.wps.LiteralDataType#getDataType <em>Data Type</em>}</li>
 *   <li>{@link net.opengis.wps.LiteralDataType#getUom <em>Uom</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wps.WpsPackage#getLiteralDataType()
...
public interface LiteralDataType extends EObject {
	 ...
	 * @see #setValue(String)
	 * @see net.opengis.wps.WpsPackage#getLiteralDataType_Value()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.LiteralDataType#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getLiteralDataType_DataType()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.LiteralDataType#getDataType <em>Data Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setUom(String)
	 * @see net.opengis.wps.WpsPackage#getLiteralDataType_Uom()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.AnyURI"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.LiteralDataType#getUom <em>Uom</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
