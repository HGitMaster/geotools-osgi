 ...
 * </copyright>
 *
 * $Id: WpsValidator.java 30810 2008-06-25 17:29:43Z jdeolive $
 */
package net.opengis.wps.util;
 ...
 * <!-- end-user-doc -->
 * @see net.opengis.wps.WpsPackage
 * @generated
 */
public class WpsValidator extends EObjectValidator {
     ...
     * @generated
     */
	public static final String DIAGNOSTIC_SOURCE = "net.opengis.wps";
	...
	public boolean validatePercentCompletedType_Min(BigInteger percentCompletedType, DiagnosticChain diagnostics, Map context) {
        ...
        if (!result && diagnostics != null) 
            reportMinViolation(WpsPackage.eINSTANCE.getPercentCompletedType(), percentCompletedType, PERCENT_COMPLETED_TYPE__MIN__VALUE, true, diagnostics, context);
        return result; 
    }
	...
	public boolean validatePercentCompletedType_Max(BigInteger percentCompletedType, DiagnosticChain diagnostics, Map context) {
        ...
        if (!result && diagnostics != null) 
            reportMaxViolation(WpsPackage.eINSTANCE.getPercentCompletedType(), percentCompletedType, PERCENT_COMPLETED_TYPE__MAX__VALUE, true, diagnostics, context);
        return result; 
    }
