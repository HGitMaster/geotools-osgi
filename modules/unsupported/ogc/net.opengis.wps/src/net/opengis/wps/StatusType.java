 ...
 * </copyright>
 *
 * $Id: StatusType.java 30488 2008-06-02 23:31:41Z gdavis $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.StatusType#getProcessAccepted <em>Process Accepted</em>}</li>
 *   <li>{@link net.opengis.wps.StatusType#getProcessStarted <em>Process Started</em>}</li>
 *   <li>{@link net.opengis.wps.StatusType#getProcessPaused <em>Process Paused</em>}</li>
 *   <li>{@link net.opengis.wps.StatusType#getProcessSucceeded <em>Process Succeeded</em>}</li>
 *   <li>{@link net.opengis.wps.StatusType#getProcessFailed <em>Process Failed</em>}</li>
 *   <li>{@link net.opengis.wps.StatusType#getCreationTime <em>Creation Time</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wps.WpsPackage#getStatusType()
...
public interface StatusType extends EObject {
	 ...
	 * @see net.opengis.wps.WpsPackage#getStatusType_ProcessAccepted()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.StatusType#getProcessAccepted <em>Process Accepted</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getStatusType_ProcessStarted()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.StatusType#getProcessStarted <em>Process Started</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getStatusType_ProcessPaused()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.StatusType#getProcessPaused <em>Process Paused</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getStatusType_ProcessSucceeded()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.StatusType#getProcessSucceeded <em>Process Succeeded</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getStatusType_ProcessFailed()
	 * @model containment="true"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.StatusType#getProcessFailed <em>Process Failed</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getStatusType_CreationTime()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.StatusType#getCreationTime <em>Creation Time</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
