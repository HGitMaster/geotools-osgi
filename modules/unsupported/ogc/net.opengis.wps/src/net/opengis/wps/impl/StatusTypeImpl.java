 ...
 * </copyright>
 *
 * $Id: StatusTypeImpl.java 29861 2008-04-09 04:55:54Z jdeolive $
 */
...
import net.opengis.wps.ProcessStartedType;
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.impl.StatusTypeImpl#getProcessAccepted <em>Process Accepted</em>}</li>
 *   <li>{@link net.opengis.wps.impl.StatusTypeImpl#getProcessStarted <em>Process Started</em>}</li>
 *   <li>{@link net.opengis.wps.impl.StatusTypeImpl#getProcessPaused <em>Process Paused</em>}</li>
 *   <li>{@link net.opengis.wps.impl.StatusTypeImpl#getProcessSucceeded <em>Process Succeeded</em>}</li>
 *   <li>{@link net.opengis.wps.impl.StatusTypeImpl#getProcessFailed <em>Process Failed</em>}</li>
 *   <li>{@link net.opengis.wps.impl.StatusTypeImpl#getCreationTime <em>Creation Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StatusTypeImpl extends EObjectImpl implements StatusType {
	...
	protected EClass eStaticClass() {
		return WpsPackage.eINSTANCE.getStatusType();
	}
	...
	public void setProcessAccepted(String newProcessAccepted) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.STATUS_TYPE__PROCESS_ACCEPTED, oldProcessAccepted, processAccepted));
	}
	...
	public NotificationChain basicSetProcessStarted(ProcessStartedType newProcessStarted, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WpsPackage.STATUS_TYPE__PROCESS_STARTED, oldProcessStarted, newProcessStarted);
	...
	public void setProcessStarted(ProcessStartedType newProcessStarted) {
		if (newProcessStarted != processStarted) {
			...
			if (processStarted != null)
				msgs = ((InternalEObject)processStarted).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WpsPackage.STATUS_TYPE__PROCESS_STARTED, null, msgs);
			if (newProcessStarted != null)
				msgs = ((InternalEObject)newProcessStarted).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WpsPackage.STATUS_TYPE__PROCESS_STARTED, null, msgs);
			msgs = basicSetProcessStarted(newProcessStarted, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.STATUS_TYPE__PROCESS_STARTED, newProcessStarted, newProcessStarted));
	}
	...
	public NotificationChain basicSetProcessPaused(ProcessStartedType newProcessPaused, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WpsPackage.STATUS_TYPE__PROCESS_PAUSED, oldProcessPaused, newProcessPaused);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProcessPaused(ProcessStartedType newProcessPaused) {
		if (newProcessPaused != processPaused) {
			...
			if (processPaused != null)
				msgs = ((InternalEObject)processPaused).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WpsPackage.STATUS_TYPE__PROCESS_PAUSED, null, msgs);
			if (newProcessPaused != null)
				msgs = ((InternalEObject)newProcessPaused).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WpsPackage.STATUS_TYPE__PROCESS_PAUSED, null, msgs);
			msgs = basicSetProcessPaused(newProcessPaused, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.STATUS_TYPE__PROCESS_PAUSED, newProcessPaused, newProcessPaused));
	}
	...
	public void setProcessSucceeded(String newProcessSucceeded) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.STATUS_TYPE__PROCESS_SUCCEEDED, oldProcessSucceeded, processSucceeded));
	}
	...
	public NotificationChain basicSetProcessFailed(ProcessFailedType newProcessFailed, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, WpsPackage.STATUS_TYPE__PROCESS_FAILED, oldProcessFailed, newProcessFailed);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setProcessFailed(ProcessFailedType newProcessFailed) {
		if (newProcessFailed != processFailed) {
			...
			if (processFailed != null)
				msgs = ((InternalEObject)processFailed).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - WpsPackage.STATUS_TYPE__PROCESS_FAILED, null, msgs);
			if (newProcessFailed != null)
				msgs = ((InternalEObject)newProcessFailed).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - WpsPackage.STATUS_TYPE__PROCESS_FAILED, null, msgs);
			msgs = basicSetProcessFailed(newProcessFailed, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.STATUS_TYPE__PROCESS_FAILED, newProcessFailed, newProcessFailed));
	}
	...
	public void setCreationTime(XMLGregorianCalendar newCreationTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WpsPackage.STATUS_TYPE__CREATION_TIME, oldCreationTime, creationTime));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case WpsPackage.STATUS_TYPE__PROCESS_STARTED:
				return basicSetProcessStarted(null, msgs);
			case WpsPackage.STATUS_TYPE__PROCESS_PAUSED:
				return basicSetProcessPaused(null, msgs);
			case WpsPackage.STATUS_TYPE__PROCESS_FAILED:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case WpsPackage.STATUS_TYPE__PROCESS_SUCCEEDED:
				return getProcessSucceeded();
			case WpsPackage.STATUS_TYPE__PROCESS_FAILED:
				return getProcessFailed();
			case WpsPackage.STATUS_TYPE__CREATION_TIME:
