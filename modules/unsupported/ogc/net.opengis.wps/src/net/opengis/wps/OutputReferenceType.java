 ...
 * </copyright>
 *
 * $Id: OutputReferenceType.java 30488 2008-06-02 23:31:41Z gdavis $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.OutputReferenceType#getEncoding <em>Encoding</em>}</li>
 *   <li>{@link net.opengis.wps.OutputReferenceType#getHref <em>Href</em>}</li>
 *   <li>{@link net.opengis.wps.OutputReferenceType#getMimeType <em>Mime Type</em>}</li>
 *   <li>{@link net.opengis.wps.OutputReferenceType#getSchema <em>Schema</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wps.WpsPackage#getOutputReferenceType()
...
public interface OutputReferenceType extends EObject {
	 ...
	 * @see net.opengis.wps.WpsPackage#getOutputReferenceType_Encoding()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.OutputReferenceType#getEncoding <em>Encoding</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setHref(String)
	 * @see net.opengis.wps.WpsPackage#getOutputReferenceType_Href()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.OutputReferenceType#getHref <em>Href</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getOutputReferenceType_MimeType()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.OutputReferenceType#getMimeType <em>Mime Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getOutputReferenceType_Schema()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.AnyURI"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.OutputReferenceType#getSchema <em>Schema</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
