 ...
 * </copyright>
 *
 * $Id: OutputDefinitionType.java 30488 2008-06-02 23:31:41Z gdavis $
 */
 ...
 * <ul>
 *   <li>{@link net.opengis.wps.OutputDefinitionType#getIdentifier <em>Identifier</em>}</li>
 *   <li>{@link net.opengis.wps.OutputDefinitionType#getEncoding <em>Encoding</em>}</li>
 *   <li>{@link net.opengis.wps.OutputDefinitionType#getMimeType <em>Mime Type</em>}</li>
 *   <li>{@link net.opengis.wps.OutputDefinitionType#getSchema <em>Schema</em>}</li>
 *   <li>{@link net.opengis.wps.OutputDefinitionType#getUom <em>Uom</em>}</li>
 * </ul>
 * </p>
 *
 * @see net.opengis.wps.WpsPackage#getOutputDefinitionType()
...
public interface OutputDefinitionType extends EObject {
	 ...
	 * @see net.opengis.wps.WpsPackage#getOutputDefinitionType_Identifier()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.OutputDefinitionType#getIdentifier <em>Identifier</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getOutputDefinitionType_Encoding()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.OutputDefinitionType#getEncoding <em>Encoding</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getOutputDefinitionType_MimeType()
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.OutputDefinitionType#getMimeType <em>Mime Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see net.opengis.wps.WpsPackage#getOutputDefinitionType_Schema()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.AnyURI"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.OutputDefinitionType#getSchema <em>Schema</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setUom(String)
	 * @see net.opengis.wps.WpsPackage#getOutputDefinitionType_Uom()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.AnyURI"
	...
	/**
	 * Sets the value of the '{@link net.opengis.wps.OutputDefinitionType#getUom <em>Uom</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
