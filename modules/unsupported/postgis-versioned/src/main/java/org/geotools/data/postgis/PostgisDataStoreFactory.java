 ...
 *
 *
 * @source $URL: http://svn.osgeo.org/geotools/tags/8.0-M1/modules/unsupported/postgis-versioned/src/main/java/org/geotools/data/postgis/PostgisDataStoreFactory.java $
 */
