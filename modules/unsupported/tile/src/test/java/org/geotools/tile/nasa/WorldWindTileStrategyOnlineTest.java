...
public class WorldWindTileStrategyOnlineTest extends TestCase {
    ...
    public void testAccessorFailover() throws IOException {
        ...
        ImageReader jpeg = (ImageReader) ImageIO.getImageReadersByFormatName("jpeg").next();
    ...
    public void testLevel0SingleTile() throws IOException {
        ...
        assertEquals( requestBounds2D.getMinX(), envelope2D.getMinX(), 0.0 );
        assertEquals( requestBounds2D.getMinY(), envelope2D.getMinY(), 0.0 );
        assertEquals( requestBounds2D.getMaxX(), envelope2D.getMaxX(), 0.0 );
        assertEquals( requestBounds2D.getMaxY(), envelope2D.getMaxY(), 0.0 );
