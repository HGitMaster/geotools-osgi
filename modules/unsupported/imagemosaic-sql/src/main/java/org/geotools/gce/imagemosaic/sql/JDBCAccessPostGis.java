...
class JDBCAccessPostGis extends JDBCAccessBase {
    ...
    private void initStatementStrings(Config config) {
        ...
        final String spatialSelectClause = "select s." +
            ...
            "asbinary(st_envelope(s." + geomAttr + "))";
        ...
        String whereClause = "st_intersects(" + geomAttr + "," +
            "GeomFromWKB(?,?))";
    ...
    protected Envelope getExtent(ImageLevelInfo li, Connection con)
        ...
        String extentSelect = getExtentSelectStatement(li);
        ...
        if (r.next()) {
            ...
            extent = new Envelope(new Coordinate(new Double(lower[0]),
                        new Double(lower[1])),
    ...
    @Override
    protected String getMatchSelectStatement(ImageLevelInfo levelInfo)
    {
    ...
    @Override
    protected String getTileSelectStatement(ImageLevelInfo levelInfo)
    {
        // TODO Auto-generated method stub
        return null;
    }
    ...
    @Override
    protected String getTileEnvelopeSelectStatement(ImageLevelInfo levelInfo)
    {
        // TODO Auto-generated method stub
        return null;
    }
