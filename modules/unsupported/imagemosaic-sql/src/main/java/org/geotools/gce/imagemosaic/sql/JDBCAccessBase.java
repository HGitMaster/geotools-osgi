...
abstract class JDBCAccessBase implements JDBCAccess {
    ...
    protected void initFromDB(String coverageName, Connection con)
        ...
        try {
            ...
            while (res.next()) {
                ...
                imageLevelInfo.setSpatialTableName(res.getString(
                        config.getSpatialTableNameAtribute()));
                imageLevelInfo.setTileTableName((res.getString(
                ...
                if (config.getVerifyCardinality().booleanValue()) {
                    ...
                    if (imageLevelInfo.getSpatialTableName()
                ...
                imageLevelInfo.setExtentMaxX(new Double(res.getDouble(
                ...
                imageLevelInfo.setExtentMaxY(new Double(res.getDouble(
                ...
                imageLevelInfo.setExtentMinX(new Double(res.getDouble(
                ...
                imageLevelInfo.setExtentMinY(new Double(res.getDouble(
                ...
                imageLevelInfo.setResX(new Double(res.getDouble(
                ...
                imageLevelInfo.setResY(new Double(res.getDouble(
     ...
     */
    protected abstract String getExtentSelectStatement(ImageLevelInfo li);
    ...
    protected Envelope getExtent(ImageLevelInfo li, Connection con)
        throws SQLException, IOException {
        String statementString = getExtentSelectStatement(li);
        Envelope extent = null;
        PreparedStatement s = con.prepareStatement(statementString);
        ResultSet r = s.executeQuery();

        if (r.next()) {
            extent = new Envelope(new Coordinate(r.getDouble(1), r.getDouble(2)),
    ...
    protected Envelope getTileEnvelope(String tileId, ImageLevelInfo li, Connection con) 
        throws SQLException
    {
    ...
    protected abstract String getTileSelectStatement(ImageLevelInfo levelInfo);

    protected abstract String getTileEnvelopeSelectStatement(ImageLevelInfo levelInfo);


    protected abstract String getMatchSelectStatement(ImageLevelInfo levelInfo);
    ...
    protected Envelope getEnvelopeFromResultSet(ResultSet r)
        throws SQLException {
        Envelope result = new Envelope(new Coordinate(r.getDouble(2),
                    r.getDouble(3)),
    ...
    public List<?> getMatchingTileIds(ImageLevelInfo levelInfo, org.opengis.geometry.Envelope requestEnvelope)
    {
        List<Object> imageRefs = new ArrayList<Object>();
    ...
    public ReferencedEnvelope getTileEnvelope(ImageLevelInfo levelInfo, Object tileId)
    {
        ...
        try {
            ...
            if (r.next()) {
                envelope = new ReferencedEnvelope(getEnvelopeFromResultSet(r), levelInfo.getCrs());
            }
            r.close();
            s.close();
            con.close();
    ...
    public ImageInputStream getImageInputStream(ImageLevelInfo levelInfo, Object tileId)
    {
        ...
        {
            LOGGER.log(Level.SEVERE, "IO error", exc);
        }
