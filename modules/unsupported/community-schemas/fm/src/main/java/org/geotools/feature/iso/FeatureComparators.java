 ...
 * @source $URL: http://gtsvn.refractions.net/trunk/modules/unsupported/community-schemas/fm/src/main/java/org/geotools/feature/iso/FeatureComparators.java $
 */
public final class FeatureComparators {
    ...
    public static class Index implements java.util.Comparator {
        ...
        public int compare(Object o1, Object o2) {
            ...
            return compareAtts(f1.getValue(idx), f2.getValue(idx));
        }
    ...
    public static class Name implements java.util.Comparator {
        ...
        public int compare(Object o1, Object o2) {
            ...
            return compareAtts(f1.getValue(name), f2.getValue(name));
        }
