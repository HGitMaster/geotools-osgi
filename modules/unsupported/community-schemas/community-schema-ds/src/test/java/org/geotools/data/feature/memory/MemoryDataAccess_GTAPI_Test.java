 ...
 * @source $URL:
 *         http://svn.geotools.org/geotools/trunk/gt/modules/library/main/src/test/java/org/geotools/data/memory/MemoryDataAccessTest.java $
 */
public class MemoryDataAccess_GTAPI_Test extends DataTestCase {
    MemoryDataAccess data;

    /**
     * Constructor for MemoryDataAccessTest.
     * 
     * @param arg0
     */
    public MemoryDataAccess_GTAPI_Test(String arg0) {
        super(arg0);
    }
    ...
    public void testMemoryDataAccess() throws Exception {
        DataStore store = new MemoryDataAccess();
    }

    /*
     * Test for void MemoryDataAccess(FeatureCollection)
     */
    public void testMemoryDataAccessFeatureCollection() {
        DataStore store = new MemoryDataAccess(DataUtilities
                .collection(roadFeatures));
    }

    /*
     * Test for void MemoryDataAccess(FeatureReader)
     */
    public void testMemoryDataAccessFeatureArray() throws IOException {
        DataStore store = new MemoryDataAccess(roadFeatures);
    }

    /*
     * Test for void MemoryDataAccess(FeatureReader)
     */
    public void testMemoryDataAccessFeatureReader() throws Exception {
        FeatureReader reader = DataUtilities.reader(roadFeatures);
        DataStore store = new MemoryDataAccess(reader);
    }
    ...
    public void testGetFeatureReaderConcurancy() throws NoSuchElementException,
    ...
    public void testGetFeatureReaderFilterAutoCommit()
        ...
        reader = data.getFeatureReader(
                new DefaultQuery("road", Filter.EXCLUDE),
                Transaction.AUTO_COMMIT);
    ...
    public void testGetFeatureReaderFilterTransaction()
        ...
        reader = data.getFeatureReader(
                new DefaultQuery("road", Filter.EXCLUDE), t);
        assertTrue(reader instanceof EmptyFeatureReader);
        assertEquals(type, reader.getFeatureType());
        assertEquals(0, count(reader));
        ...
        // assertTrue(reader instanceof DiffFeatureReader);//Currently wrapped
        // by a filtering
        // feature reader
        assertEquals(type, reader.getFeatureType());
        assertEquals(1, count(reader));
    ...
    void dump(FeatureReader reader) throws NoSuchElementException, IOException,
            IllegalAttributeException {
        Feature feature;
        int count = 0;
     ...
     */
    public void testGetFeatureWriter() throws NoSuchElementException,
            IOException, IllegalAttributeException {
    ...
    public void testGetFeaturesWriterModify() throws IOException,
        ...
        f = (org.opengis.feature.simple.SimpleFeature) data.features("road")
                .get("road.rd1");
        assertEquals("changed", f.getValue("name"));
    }
     ...
     */
    public void testGetFeatureWriterFilter() throws NoSuchElementException,
            IOException, IllegalAttributeException {
        FeatureWriter writer;
    ...
    /**
     * Test the transaction when multiple edits occur using a transaction and a
     * fid filter.
     */
    ...
    public void testGetFeatureSourceRiver() throws NoSuchElementException,
            IOException, IllegalAttributeException {
    ...
    public void testFeatureEvents() throws Exception {
        FeatureStore store1 = (FeatureStore) data
     ...
     * no need for locking.
     */
    public void _Pending_testGetFeatureLockingExpire() throws Exception {
