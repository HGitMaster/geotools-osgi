 ...
 * @source $URL: http://svn.osgeo.org/geotools/tags/2.6.5/modules/unsupported/geometryless/src/test/java/org/geotools/data/geometryless/LocationsXYDataStoreTest.java $
 */
...
//    private  tFilter;
   ...
   // private org.geotools.filter.GeometryFilter geomFilter;
    ...
    public static Test suite() {
        ...
        TestSuite suite = new TestSuite(LocationsXYDataStoreTest.class);
        ...
        String password = resource.getString("password");
           ...
           String dbschema = resource.getString("schema");
            ...
            local.put("urlprefix", urlprefix);
             ...
             String xcolumn = resource.getString("xcolumn");
