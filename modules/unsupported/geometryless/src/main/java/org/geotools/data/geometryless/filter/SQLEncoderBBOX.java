 ...
 * based on xmin,ymin, xmax, ymax (longitude/latitude) columns ..
 *
 * @author Rob Atkinson , SCO
 * 
 * @source $URL: http://gtsvn.refractions.net/trunk/modules/unsupported/geometryless/src/main/java/org/geotools/data/geometryless/filter/SQLEncoderBBOX.java $
 */
