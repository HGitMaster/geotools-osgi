...
/**
 * Class for testing availability of ECW format factory
 *
...
public class ServiceTest extends AbstractECWTestCase {
    ...
    public void testIsAvailable() throws NoSuchAuthorityCodeException, FactoryException {
        ...
        assertTrue("ECWFormatFactory not registered", found);
        assertTrue("ECWFormatFactory not available", fac.isAvailable());
        assertNotNull(new ECWFormatFactory().createFormat());
    }
}
