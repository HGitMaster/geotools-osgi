 ...
 *
 *
 * @source $URL: http://svn.osgeo.org/geotools/tags/8.0-M1/modules/unsupported/geometry/src/main/java/org/geotools/geometry/iso/util/algorithm2D/LineLineIntersection2D.java $
 */
