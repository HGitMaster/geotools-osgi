...
public class AbstractPostPreProcessFilterSplittingVisitorTests{
	...
	protected PostPreProcessFilterSplittingVisitor newVisitor(Capabilities supportedCaps) throws SchemaException {
    ...
    protected void runTest(Filter filter, Capabilities supportedCaps, String attToEdit) throws SchemaException {
        ...
        PostPreProcessFilterSplittingVisitor visitor=newVisitor(new Capabilities()); 
		if (accessor!=null )
