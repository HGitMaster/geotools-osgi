 ...
 * @since 2.5.x
 *
 * @source $URL: http://svn.osgeo.org/geotools/tags/8.0-M1/modules/plugin/imageio-ext-gdal/src/main/java/org/geotools/coverageio/gdal/erdasimg/ErdasImgFormat.java $
 */
