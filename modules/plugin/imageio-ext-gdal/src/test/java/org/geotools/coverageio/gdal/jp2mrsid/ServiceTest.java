 ...
 *
 */
public class ServiceTest extends AbstractJP2MrSIDTestCase {
    ...
    public void testIsAvailable() throws NoSuchAuthorityCodeException, FactoryException {
        ...
        assertTrue("JP2MrSIDFormatFactory not registered", found);
        assertTrue("JP2MrSIDFormatFactory not available", fac.isAvailable());
        assertNotNull(new JP2MrSIDFormatFactory().createFormat());
    }
}
