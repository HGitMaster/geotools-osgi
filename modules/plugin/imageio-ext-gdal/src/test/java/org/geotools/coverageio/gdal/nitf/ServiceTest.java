 ...
 */
public class ServiceTest extends AbstractNITFTestCase {
	...
	public void testIsAvailable() throws NoSuchAuthorityCodeException,
		...
		assertTrue("NITFFormatFactory not registered", found);
		assertTrue("NITFFormatFactory not available", fac.isAvailable());
		assertNotNull(new NITFFormatFactory().createFormat());
	}
}
