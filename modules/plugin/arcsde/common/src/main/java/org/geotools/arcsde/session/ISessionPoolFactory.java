 ...
 * 
 *
 * @source $URL: http://svn.osgeo.org/geotools/tags/8.0-M1/modules/plugin/arcsde/common/src/main/java/org/geotools/arcsde/session/ISessionPoolFactory.java $
 * @version $Id: ISessionPoolFactory.java 37302 2011-05-25 05:52:19Z mbedward $
 * @since 2.5.7
 */
