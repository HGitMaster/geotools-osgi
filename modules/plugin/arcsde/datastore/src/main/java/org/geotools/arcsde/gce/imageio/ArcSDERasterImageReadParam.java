 ...
 * band in the output image to which the given SeRasterBand should be copied.<br/><br/>For example,
 * if your ArcSDE Raster contains four bands with SeRasterBand.getId().longValue()s of 234,235,236
 * and 237, and you wish to map those bands to the R,G,B and A bands in your ARGB image, you should
 * create a map as follows:<br/> Map m = new HashMap();<br/> m.put(new Integer(234), new
 * Integer(1));<br/> m.put(new Integer(234), new Integer(2));<br/> m.put(new Integer(234), new
 * Integer(3));<br/> m.put(new Integer(234), new Integer(0));<br/> <br/> Note that the band indexes
 * you choose will depend on the type of BufferedImage you're writing to. A BufferedImage of type
 * BufferedImage.TYPE_INT_ARGB has its bands in the order "Alpha (0), Red (1), Green (2), Blue
 ...
 * output appropriately.<br/> <i><b>If you leave this parameter null, a BufferedImage.TYPE_INT_ARGB
 * will be created, of exactly the size to cover your requested source region</b></i></li>
