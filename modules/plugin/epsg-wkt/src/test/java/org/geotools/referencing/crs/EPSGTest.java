 ...
 * @author Jody Garnett
 * @since 2.1.M3
 * @source $URL: http://gtsvn.refractions.net/trunk/modules/plugin/epsg-wkt/src/test/java/org/geotools/referencing/crs/EPSGTest.java $
 * @version 2.1.M3
 */
