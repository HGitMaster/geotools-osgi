 ...
 *
 *
 * @source $URL: http://svn.osgeo.org/geotools/tags/8.0-M1/modules/library/render/src/main/java/org/geotools/referencing/piecewise/DefaultLinearPiecewiseTransform1DElement.java $
 */
