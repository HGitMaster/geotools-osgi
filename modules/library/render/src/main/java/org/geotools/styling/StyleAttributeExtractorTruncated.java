 ...
 *     a) it doesnt the count the <PropertyName> tag in the <Geometry> 
 *     b) it doesnt count anything in the <TextSymbolizer>'s <Priority> tag
 *     c) it doesnt count anything in the <TextSymbolizer>'s <Label> tag
 *     
 *     The reasons for this are because these fields are ALWAYS taken directly from the
 *     feature, not from the style.
 *     
 *     So, for making queries (knowing any property that might be possibily be used in the SLD), use
 *     StyleAttributeExtractor.  If you want to know what a symbolizer actually needs to cache, then
 *     use this (StyleAttributeExtractorTruncated).
 *
 * @author dblasby
 * @source $URL: http://gtsvn.refractions.net/trunk/modules/library/render/src/main/java/org/geotools/styling/StyleAttributeExtractorTruncated.java $
 */
