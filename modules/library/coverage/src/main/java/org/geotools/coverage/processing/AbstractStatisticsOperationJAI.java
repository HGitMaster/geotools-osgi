 ...
 *
 *
 * @source $URL: http://svn.osgeo.org/geotools/tags/8.0-M1/modules/library/coverage/src/main/java/org/geotools/coverage/processing/AbstractStatisticsOperationJAI.java $
 */
