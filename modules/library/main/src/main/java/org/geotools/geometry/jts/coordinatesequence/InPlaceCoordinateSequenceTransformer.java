 ...
 * @since 0.6.0
 *
 * @source $URL: http://svn.osgeo.org/geotools/tags/8.0-M1/modules/library/main/src/main/java/org/geotools/geometry/jts/coordinatesequence/InPlaceCoordinateSequenceTransformer.java $
 */
