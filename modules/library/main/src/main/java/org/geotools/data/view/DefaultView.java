 ...
 * @source $URL: http://gtsvn.refractions.net/trunk/modules/library/main/src/main/java/org/geotools/data/view/DefaultView.java $
 */
public class DefaultView implements FeatureSource<SimpleFeatureType, SimpleFeature> {
     ...
     */
    public DefaultView(FeatureSource<SimpleFeatureType, SimpleFeature> source, Query query) throws SchemaException {
        this.source = source;
