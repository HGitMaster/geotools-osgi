 ...
 * @author Cory Horner
 * @since 2.2M2
 * @source $URL: http://svn.osgeo.org/geotools/tags/2.6.5/modules/library/main/src/main/java/org/geotools/filter/function/Collection_UniqueFunction.java $
 */
public class Collection_UniqueFunction extends FunctionExpressionImpl
     ...
     * @throws IOException 
     */
    static CalcResult calculateUnique(FeatureCollection<SimpleFeatureType, SimpleFeature> collection,
