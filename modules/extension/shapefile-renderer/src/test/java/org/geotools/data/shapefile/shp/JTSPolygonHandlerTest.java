 ...
 * @author jeichar
 * @since 2.1.x
 * @source $URL: http://gtsvn.refractions.net/trunk/modules/extension/shapefile-renderer/src/test/java/org/geotools/data/shapefile/shp/JTSPolygonHandlerTest.java $
 */
