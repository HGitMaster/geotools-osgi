 ...
 *
 * @since 2.1.x
 * @source $URL: http://gtsvn.refractions.net/trunk/modules/extension/shapefile-renderer/src/main/java/org/geotools/renderer/shape/GeometryHandlerUtilities.java $
 */
