 ...
 * @since 2.5.x
 * @source $URL: http://gtsvn.refractions.net/trunk/modules/extension/xsd/xsd-wfs/src/test/java/org/geotools/wfs/bindings/TransactionResponseTypeBindingTest.java $
 */
