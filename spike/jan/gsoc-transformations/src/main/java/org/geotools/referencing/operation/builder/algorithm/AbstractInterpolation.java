 ...
 * 
 * @source $URL: http://gtsvn.refractions.net/trunk/spike/jan/gsoc-transformations/src/main/java/org/geotools/referencing/operation/builder/algorithm/AbstractInterpolation.java $
