...
/**
 * A <code>RIF</code> supporting the "Xor" operation in the
...
public class MlibXorRIF implements RenderedImageFactory {
    ...
    /**
     * Creates a new instance of <code>MlibXorOpImage</code> in
    ...
    public RenderedImage create(ParameterBlock args,
        ...
        return new MlibXorOpImage(args.getRenderedSource(0),
