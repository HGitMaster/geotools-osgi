/*
 * $RCSfile: MlibAddConstOpImage.java,v $
 *
...
final class MlibAddConstOpImage extends PointOpImage {
    ...
    /**
     * Constructs an MlibAddConstOpImage. The image dimensions are copied
     ...
     */
    public MlibAddConstOpImage(RenderedImage source,
                               Map config,
                               ImageLayout layout,
                               double[] constants) {
    ...
    /**
     * Add the pixel values of a rectangle with a given constant.
    ...
    protected void computeRect(Raster[] sources,
        ...
        case DataBuffer.TYPE_INT:
            ...
            for (int i = 0; i < dstML.length; i++) {
                ...
                Image.ConstAdd(dstML[i], srcML[i], mlconstants);
            }
            break;
        ...
        case DataBuffer.TYPE_DOUBLE:
            for (int i = 0; i < dstML.length; i++) {
                ...
                Image.ConstAdd_Fp(dstML[i], srcML[i], mlconstants);
            }
            break;
...
//         double[] consts = { 5, 5, 5 };
//         return new MlibAddConstOpImage(oit.getSource(), null,
...
//         String classname = "com.sun.media.jai.mlib.MlibAddConstOpImage";
