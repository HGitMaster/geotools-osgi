...
/**
 * A <code>RIF</code> supporting the "Erode" operation in the
 * rendered image mode using MediaLib.
 *
 * @see javax.media.jai.operator.ErodeDescriptor
 * @see MlibErodeOpImage
 */
public class MlibErodeRIF implements RenderedImageFactory {
    ...
    /**
     * Creates a new instance of <code>MlibErodeOpImage</code> in
     * the rendered image mode.
     *
     * @param args  The source image and erosion kernel.
