...
/**
 * An OpImage that performs the And operation on 2 images through mediaLib.
 *
 */
final class MlibAndOpImage extends PointOpImage {

    /**
     * Constructs an MlibAndOpImage. The image dimensions are copied
     ...
     */
    public MlibAndOpImage(RenderedImage source1, RenderedImage source2,
                          Map config,
			  ImageLayout layout) {
    ...
    /**
     * And the pixel values of a rectangle from the two sources.
...
//         System.out.println("MlibAndOpImage Test");
//         ImageLayout layout;
...
//         dst = new MlibAndOpImage(src1, src2, null, null);
